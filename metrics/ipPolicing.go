...
func processIpPolicing(ctx lib.MetricContext, xmlBody *[]byte,system []string) {
	...
	for _, status := range IpPolicing.IpPolicingAlarms {
		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["AlarmDuration"], prometheus.GaugeValue, status.BadEthernetIpHeaderAlarmDuration, status.ServerName, status.BadEthernetIpHeaderAlarmLevel,"BadEthernetIpHeader"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["DiscardRate"], prometheus.GaugeValue, status.BadEthernetIpHeaderDiscardRate, status.ServerName, status.BadEthernetIpHeaderAlarmLevel,"BadEthernetIpHeader"))
		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["PacketsDiscarded"], prometheus.GaugeValue, status.BadEthernetIpHeaderPacketsDiscarded, status.ServerName, status.BadEthernetIpHeaderAlarmLevel,"BadEthernetIpHeader"))
   		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["AlarmDuration"], prometheus.GaugeValue, status.ArpAlarmDuration, status.ServerName, status.ArpAlarmLevel,"Arp"))
		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["DiscardRate"], prometheus.GaugeValue, status.ArpDiscardRate, status.ServerName, status.ArpAlarmLevel,"Arp"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["PacketsDiscarded"], prometheus.GaugeValue, status.ArpPacketsDiscarded, status.ServerName, status.ArpAlarmLevel,"Arp"))
		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["PacketsAccepted"], prometheus.GaugeValue, status.ArpPacketsAccepted, status.ServerName, status.ArpAlarmLevel,"Arp"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["AlarmDuration"], prometheus.GaugeValue, status.UFlowAlarmDuration, status.ServerName, status.UFlowAlarmLevel,"UFlow"))
		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["DiscardRate"], prometheus.GaugeValue, status.UFlowDiscardRate, status.ServerName, status.UFlowAlarmLevel,"UFlow"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["PacketsDiscarded"], prometheus.GaugeValue, status.UFlowPacketsDiscarded, status.ServerName, status.UFlowAlarmLevel,"UFlow"))
		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["PacketsAccepted"], prometheus.GaugeValue, status.UFlowPacketsAccepted, status.ServerName, status.UFlowAlarmLevel,"UFlow"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["AlarmDuration"], prometheus.GaugeValue, status.AclAlarmDuration, status.ServerName, status.AclAlarmLevel,"Acl"))
		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["DiscardRate"], prometheus.GaugeValue, status.AclDiscardRate, status.ServerName, status.AclAlarmLevel,"Acl"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["PacketsDiscarded"], prometheus.GaugeValue, status.AclPacketsDiscarded, status.ServerName, status.AclAlarmLevel,"Acl"))
		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["PacketsAccepted"], prometheus.GaugeValue, status.AclPacketsAccepted, status.ServerName, status.AclAlarmLevel,"Acl"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["AlarmDuration"], prometheus.GaugeValue, status.AggregateAlarmDuration, status.ServerName, status.AggregateAlarmLevel,"Aggregate"))
		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["DiscardRate"], prometheus.GaugeValue, status.AggregateDiscardRate, status.ServerName, status.AggregateAlarmLevel,"Aggregate"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["PacketsDiscarded"], prometheus.GaugeValue, status.AggregatePacketsDiscarded, status.ServerName, status.AggregateAlarmLevel,"Aggregate"))
		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["PacketsAccepted"], prometheus.GaugeValue, status.AggregatePacketsAccepted, status.ServerName, status.AggregateAlarmLevel,"Aggregate"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["AlarmDuration"], prometheus.GaugeValue, status.IpSecDecryptAlarmDuration, status.ServerName, status.IpSecDecryptAlarmLevel,"IpSecDecrypt"))
		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["DiscardRate"], prometheus.GaugeValue, status.IpSecDecryptDiscardRate, status.ServerName, status.IpSecDecryptAlarmLevel,"IpSecDecrypt"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["PacketsDiscarded"], prometheus.GaugeValue, status.IpSecDecryptPacketsDiscarded, status.ServerName, status.IpSecDecryptAlarmLevel,"IpSecDecrypt"))
		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["AlarmDuration"], prometheus.GaugeValue, status.MediaAlarmDuration, status.ServerName, status.MediaAlarmLevel,"Media"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["DiscardRate"], prometheus.GaugeValue, status.MediaDiscardRate, status.ServerName, status.MediaAlarmLevel,"Media"))
		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["PacketsDiscarded"], prometheus.GaugeValue, status.MediaPacketsDiscarded, status.ServerName, status.MediaAlarmLevel,"Media"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["AlarmDuration"], prometheus.GaugeValue, status.RogueMediaAlarmDuration, status.ServerName, status.RogueMediaAlarmLevel,"RogueMedia"))
		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["DiscardRate"], prometheus.GaugeValue, status.RogueMediaDiscardRate, status.ServerName, status.RogueMediaAlarmLevel,"RogueMedia"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["PacketsDiscarded"], prometheus.GaugeValue, status.RogueMediaPacketsDiscarded, status.ServerName, status.RogueMediaAlarmLevel,"RogueMedia"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["AlarmDuration"], prometheus.GaugeValue, status.DiscardRuleAlarmDuration, status.ServerName, status.DiscardRuleAlarmLevel,"DiscardRule"))
    	ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["DiscardRate"], prometheus.GaugeValue, status.DiscardRuleDiscardRate, status.ServerName, status.DiscardRuleAlarmLevel,"DiscardRule"))
   		ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["PacketsDiscarded"], prometheus.GaugeValue, status.DiscardRulePacketsDiscarded, status.ServerName, status.DiscardRuleAlarmLevel,"DiscardRule"))
    ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["AlarmDuration"], prometheus.GaugeValue, status.SrtpDecryptAlarmDuration, status.ServerName, status.SrtpDecryptAlarmLevel,"SrtpDecrypt"))
    ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["DiscardRate"], prometheus.GaugeValue, status.SrtpDecryptDiscardRate, status.ServerName, status.SrtpDecryptAlarmLevel,"SrtpDecrypt"))
    ctx.MetricArray = append(ctx.MetricArray,prometheus.MustNewConstMetric(IpPolicingMetrics["PacketsDiscarded"], prometheus.GaugeValue, status.SrtpDecryptPacketsDiscarded, status.ServerName, status.SrtpDecryptAlarmLevel,"SrtpDecrypt"))
	}
